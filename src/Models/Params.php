...
class Params
{
    ...
    public static function toLat($coordinates)
    {
        ...
        if(empty($coordinatesArr[0]) || empty($coordinatesArr[1]))
        {
            return false;
        } else {
            $result = trim($coordinatesArr[0]);
            return $result;
        }
    }

    public static function toLong($coordinates)
    {
        if(empty($coordinates))
        {
            return false;
